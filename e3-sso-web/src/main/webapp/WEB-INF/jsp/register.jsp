...
<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="Cache-Control" content="no-cache,must-revalidate">
		...
		<link rel="stylesheet" type="text/css"
			href="login_js/css/headerfooter.css" />
		<link rel="stylesheet" type="text/css"
			href="login_js/css/jquery.alerts.css" />
		<link rel="stylesheet" type="text/css"
			href="login_js/css/headerfooterindex.css" />
		<script type="text/javascript" src="login_js/js/jquery-1.5.1.min.js"></script>
		<script type="text/javascript" src="login_js/js/jquery.cookie.js"></script>
		<script type="text/javascript"
			src="login_js/js/passport.common.js?v20140531"></script>
		<script type="text/javascript" src="login_js/js/jquery.alerts.js"></script>
		<script type="text/javascript" src="login_js/js/png.js?v20140521"></script>
</head>
<body>
	<!-- header -->
	<div class="header">
		<a href="#"><img src="login_js/images/logo.png" border="0" /><span>欢迎注册</span></a>
	</div>

	<!--mainStart-->
	<link rel="stylesheet" type="text/css"
		href="login_js/css/reg.css?v20140432" />
	<script type="text/javascript" src="login_js/js/allMail.js?v20140430"></script>
	<script type="text/javascript" src="login_js/js/reg.js?v20150122"></script>
	<!-- reg_main -->
				...
				<li class="regPl88"><span class="regM"
					style="margin-left: 29px"> <input id="AgreeId"
						name="AgreeId" type="checkbox" checked="" onclick="ckAgree();">
							...
							class="checkTitle">我已阅读并同意<font style="font-size: 12px;">《宜立方商城用户注册协议》</font></a></span>
